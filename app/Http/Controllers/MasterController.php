...
class MasterController extends Controller
{
    ...
    public function index_kategori(request $request){
        ...
        return view('master.index_kategori',compact('menu'));
    }
    ...
    public function tambah_kategori(request $request){
        ...
        $data=Kategoribarang::where('id',$request->id)->first();
        return view('master.tambah_kategori',compact('data','id','read'));
    }
    ...
    public function get_data_kategori(request $request){
        $data=Kategoribarang::where('active',1)->orderBy('kategori_barang','Asc')->get();
    ...
    public function hapus_data_kategori(request $request){
        error_reporting(0);
        $delanggota=Kategoribarang::where('id',$request->id)->update(['active'=>0]);
    ...
    public function save_data_kategori(request $request){
        error_reporting(0);
        
        $rules = [];
        $messages = [];
        
        $rules['kategori_barang']= 'required';
        $messages['kategori_barang.required']= 'Silahkan isi kategori';
        ...
        if ($validator->fails()) {
            ...
            echo'</div>';
                ...
                $save=Kategoribarang::UpdateOrcreate([
